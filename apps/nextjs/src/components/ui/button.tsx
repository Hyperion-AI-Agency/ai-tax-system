  ...
  "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive inline-flex shrink-0 items-center justify-center gap-2 rounded-md text-sm font-medium whitespace-nowrap transition-all outline-none focus:outline-none focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        // Dummy design variants
        "dummy-primary":
          "font-quicksand bg-primary text-primary-foreground hover:bg-primary/90 font-bold shadow-[0px_4px_8px_hsl(var(--primary)/0.5)]",
        "dummy-outline":
          "font-quicksand border-primary text-primary hover:bg-primary hover:text-primary-foreground border bg-transparent font-bold",
      },
      size: {
        ...
        icon: "size-9",
        // Dummy design responsive sizes
        "dummy-sm":
          "rounded-[12px] px-[17px] py-[6px] text-[8px] leading-[10px] md:rounded-[18px] md:px-[26px] md:py-[9px] md:text-[12px] md:leading-[15px] lg:rounded-[24px] lg:px-[34px] lg:py-[12px] lg:text-[16px] lg:leading-[20px]",
      },
    },
    defaultVariants: {
      variant: "default",
